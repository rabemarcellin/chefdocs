...
const DocNavigationButton = ({ title, to, prev = false, next = false }: Props) => {
  return (
    <Link to={to} className="bg-white px-4 py-2 text-slate-600 hover:text-black-600 hover:bg-blue-50 rounded-lg transition-all duration-200 font-medium text-sm flex gap-2 items-center">
